...
const schema: SettingSchema = ({
  ...
  properties: {
    ...
    'updater.source': {
      ...
      title: 'Update Channel' as any,
      type: 'string',
      enum: ['disabled', 'github'],
      options: {
        enum_titles: ['Disabled (Recommended)', 'GitHub Releases'],
      },
      group: 'security',
      required: true,
    },
    ...
    'security.profile': {
      defaultValue: '',
      title: 'Security Preset' as any,
      description: 'Choose the default trust posture for this fork. Leave empty to show the onboarding prompt again.' as any,
      type: 'string',
      enum: ['', 'safe', 'workspace', 'advanced'],
      options: {
        enum_titles: ['Prompt On Next Launch', 'Safe', 'Workspace', 'Advanced'],
      },
      group: 'security',
      required: true,
      needReloadWindowWhenChanged: true,
    },
    'security.allow-third-party-plugins': {
      defaultValue: false,
      title: 'Allow Third-Party Plugins' as any,
      description: 'Enable loading user plugins and extensions from local/plugin sources.' as any,
      type: 'boolean',
      format: 'checkbox',
      group: 'security',
      required: true,
    ...
    'security.allow-macros': {
      defaultValue: false,
      title: 'Allow Markdown Macros' as any,
      description: 'Enable JavaScript-backed markdown macros for trusted workspaces.' as any,
      type: 'boolean',
      format: 'checkbox',
      group: 'security',
      required: true,
    ...
    'security.allow-code-run': {
      defaultValue: false,
      title: 'Allow Code Runner Blocks' as any,
      description: 'Permit embedded code blocks to execute local commands.' as any,
      type: 'boolean',
      format: 'checkbox',
      group: 'security',
      required: true,
    ...
    'security.allow-html-applets': {
      defaultValue: false,
      title: 'Allow HTML Applets' as any,
      description: 'Permit embedded HTML applets in markdown preview.' as any,
      type: 'boolean',
      format: 'checkbox',
      group: 'security',
      required: true,
    ...
    'security.allow-terminal': {
      defaultValue: false,
      title: 'Allow Integrated Terminal' as any,
      description: 'Enable the integrated terminal and terminal-backed actions.' as any,
      type: 'boolean',
      format: 'checkbox',
      group: 'security',
      required: true,
    ...
    'security.allow-rpc': {
      defaultValue: false,
      title: 'Allow Main-Process RPC' as any,
      description: 'Permit renderer requests that evaluate code in the Electron main process.' as any,
      type: 'boolean',
      format: 'checkbox',
      group: 'security',
      required: true,
    ...
    'security.allow-auto-update': {
      defaultValue: false,
      title: 'Allow Automatic Updates' as any,
      description: 'Check GitHub releases for updates. Disabled by default for safer deployments.' as any,
      type: 'boolean',
      format: 'checkbox',
      group: 'security',
      required: true,
  ...
  groups: [
    ...
    { label: 'Security' as any, value: 'security' },
  ]
})
